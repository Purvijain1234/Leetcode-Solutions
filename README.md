...
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | ---------- | ---------------- | ----------- | ------------------------------------------------------------------------------ |
| 1           | [Two Sum](https://leetcode.com/problems/two-sum/)                                                                                       | Array, Hashing         | Easy       | O(n²)            | O(1)        | [C++](./0001-1000/0001_Two_Sum.cpp)                                            |
| 2           | [Add Two Numbers](https://leetcode.com/problems/add-two-numbers/)                                                                       | Linked List, Math      | Medium     | O(max(n,m))      | O(max(n,m)) | [C++](./0001-1000/0002_Add_Two_Numbers.cpp)                                    |
| 7           | [Reverse Integer](https://leetcode.com/problems/reverse-integer/)                                                                       | Math                   | Medium     | O(log n)         | O(1)        | [C++](./0001-1000/0007_Reverse_Integer.cpp)                                    |
